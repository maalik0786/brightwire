	...
	public partial class Program
	{
		...
		static IDataTable _LoadBicyclesDataTable(string dataFilePath)
		{
			...
			using (var reader = new StreamReader(dataFilePath))
			{
				...
				var filteredTable =
					completeTable.SelectColumns(Enumerable.Range(0, completeTable.ColumnCount).Skip(5));

				// normalise just the data columns
				ret = filteredTable.SelectColumns(Enumerable.Range(0, filteredTable.ColumnCount - 3)).
