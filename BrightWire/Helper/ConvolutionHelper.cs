...
namespace BrightWire.Helper
{
	...
	{
		static readonly Dictionary<(int, int, int, int, int, int), List<(int X, int Y)>> _leftToRight =
			new Dictionary<(int, int, int, int, int, int), List<(int, int)>>();
		static readonly Dictionary<(int, int, int, int, int, int), List<(int X, int Y)>> _topToBottm =
			new Dictionary<(int, int, int, int, int, int), List<(int, int)>>();
		...
		public static List<(int X, int Y)> LeftToRight(int width, int height, int filterWidth,
		...
		/// <param name="yStride">Y Stride</param>
		/// <returns>List of (x, y) indices</returns>
		public static List<(int X, int Y)> TopToBottom(int width, int height, int filterWidth,
			int filterHeight, int xStride, int yStride)
		{
			var key = (width, height, filterWidth, filterHeight, xStride, yStride);
		...
		/// <inheritdoc />
		public delegate List<(int X, int Y)> ConvolutionalDelegate(int width, int height,
