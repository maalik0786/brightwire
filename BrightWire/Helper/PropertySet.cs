...
namespace BrightWire.Helper
{
	...
	class PropertySet : IPropertySet
	{
		...
		public const string TEMPLATE_GRADIENT_DESCENT_DESCRIPTOR =
			"bw:template-gradient-descent-descriptor";
		...
		public IPropertySet Use(ICreateTemplateBasedGradientDescent descriptor)
		{
			TemplateGradientDescentDescriptor = descriptor;
			return this;
		}

		public IPropertySet Use(ICreateGradientDescent descriptor)
		{
			GradientDescentDescriptor = descriptor;
			return this;
		}

		public IPropertySet Use(IGradientDescentOptimisation optimisation)
		{
			GradientDescent = optimisation;
			return this;
		}

		public IPropertySet Use(IWeightInitialisation weightInit)
		{
			WeightInitialisation = weightInit;
			return this;
		}
