...
namespace BrightWire
{
	...
	public interface ICreateTemplateBasedGradientDescent
	{
		...
		/// <param name="propertySet">The property set that contains initialisation parameters</param>
		/// <returns></returns>
		IGradientDescentOptimisation Create(IGradientDescentOptimisation prev, IMatrix template,
	...
	public interface ILogisticRegressionTrainer
	{
		...
		/// <returns></returns>
		LogisticRegression GradientDescent(int iterations, float learningRate, float lambda = 0.1f,
	...
	public interface ILinearRegressionTrainer
	{
		...
		LinearRegression GradientDescent(int iterations, float learningRate, float lambda = 0.1f,
			Func<float, bool> costCallback = null);
