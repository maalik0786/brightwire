...
namespace BrightWire.ExecutionGraph.Node.Gate
{
	...
	{
		IMatrix _primary, _secondary;
		INode _primarySource, _secondarySource;
		...
		protected void _AddHistory(IContext context, IMatrix output,
			Func<IBackpropagation> backpropagation)
		{
			context.AddForward(
				new TrainingAction(this, new MatrixGraphData(output),
					new[] { _primarySource, _secondarySource }), backpropagation);
		}
	}
}