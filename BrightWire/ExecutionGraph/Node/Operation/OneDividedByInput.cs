	...
	class OneDividedByInput : NodeBase
	{
		...
		class Backpropagation : SingleBackpropagationBase<OneDividedByInput>
		{
				...
				IContext context, IReadOnlyList<INode> parents)
			{
				...
				using var minusOne =
					context.LinearAlgebraProvider.CreateMatrix(es.RowCount, es.ColumnCount, -1f);
		...
		public override void ExecuteForward(IContext context)
		{
			...
			using var ones =
				context.LinearAlgebraProvider.CreateMatrix(input.RowCount, input.ColumnCount, 1f);
