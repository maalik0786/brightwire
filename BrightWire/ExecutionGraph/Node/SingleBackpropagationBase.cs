...
namespace BrightWire.ExecutionGraph.Node
{
	...
	public abstract class SingleBackpropagationBase<T> : BackpropagationBase<T> where T : INode
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <param name="parents">Parents of the current node</param>
		/// <returns></returns>
		protected abstract IGraphData _Backpropagate(INode fromNode, IGraphData errorSignal,
