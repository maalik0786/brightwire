...
namespace BrightWire.ExecutionGraph
{
	...
	public class WireBuilder
	{
		...
		/// <returns></returns>
		public WireBuilder AddClassifier(IRowClassifier classifier, IDataTable dataTable,
			IDataTableAnalysis analysis = null, string name = null)
		{
		...
		public WireBuilder AddBatchNormalisation(string name = null)
		{
			...
			if (_depth > 1)
				throw new NotImplementedException(
					"Currently only implemented for non convolutional networks");
			//size = _depth;
		...
		{
			_SetNode(_factory.CreateSimpleRecurrent(CurrentSize, new float[memorySize], activation,
				name));
		...
		/// <param name="name">Optional name to give the node</param>
		/// <returns></returns>
		public WireBuilder AddElman(INode activation, INode activation2, float[] initialMemory,
			string name = null)
		{
		...
		/// <param name="name">Optional name to give the node</param>
		/// <returns></returns>
		public WireBuilder AddElman(INode activation, INode activation2, int memorySize,
			string name = null)
		{
			_SetNode(_factory.CreateElman(CurrentSize, new float[memorySize], activation, activation2,
				name));
			return SetNewSize(memorySize);
		}
		...
		/// <param name="name">Optional name to give the node</param>
		/// <returns></returns>
		public WireBuilder AddJordan(INode activation, INode activation2, float[] initialMemory,
			string name = null)
		{
		...
		/// <param name="name">Optional name to give the node</param>
		/// <returns></returns>
		public WireBuilder AddJordan(INode activation, INode activation2, int memorySize,
			string name = null)
		{
			_SetNode(_factory.CreateJordan(CurrentSize, new float[memorySize], activation, activation2,
				name));
			return SetNewSize(memorySize);
		}
		...
		/// <param name="name">Optional name to give the node</param>
		/// <returns></returns>
		public WireBuilder AddMaxPooling(int filterWidth, int filterHeight, int xStride, int yStride,
			string name = null)
		{
		...
		/// <param name="name">Optional name to give the node</param>
		/// <returns></returns>
		public WireBuilder AddConvolutional(int filterCount, int padding, int filterWidth,
			int filterHeight, int xStride, int yStride, bool shouldBackpropagate = true,
			string name = null)
		{
			_SetNode(_factory.CreateConvolutional(_depth, filterCount, padding, filterWidth, filterHeight,
				xStride, yStride, shouldBackpropagate, name));
		...
		/// <param name="name">Optional name to give the node</param>
		/// <returns></returns>
		public WireBuilder WriteNodeMemoryToSlot(string slotName, IHaveMemoryNode node,
			string name = null)
		{
