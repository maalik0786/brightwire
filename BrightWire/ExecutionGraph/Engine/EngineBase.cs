...
namespace BrightWire.ExecutionGraph.Engine
{
	abstract class EngineBase
	{
		...
		protected EngineBase(ILinearAlgebraProvider lap)
		{
			_lap = lap;
		}
		...
		protected bool _Continue(IMiniBatch batch, IExecutionContext executionContext,
			Func<IMiniBatchSequence, IContext> lookupContext)
		{
			var ret = false;
