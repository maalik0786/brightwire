...
namespace BrightWire
{
	...
	public interface ILinearAlgebraProvider : IDisposable
	{
		...
		/// <returns></returns>
		IMatrix CalculateDistances(IReadOnlyList<IVector> vectors, IReadOnlyList<IVector> comparison,
	...
	public interface I3DTensor : IDisposable
	{
		...
		(I3DTensor Result, I3DTensor Indices) MaxPool(int filterWidth, int filterHeight, int xStride,
			int yStride, bool saveIndices);
		...
		/// <param name="xStride">Filter x stride</param>
		/// <param name="yStride">Filter y stride</param>
		I3DTensor ReverseMaxPool(I3DTensor indices, int outputRows, int outputColumns, int filterWidth,
		...
		/// <param name="yStride">Filter y stride</param>
		/// <returns></returns>
		I3DTensor ReverseIm2Col(IMatrix filter, int outputRows, int outputColumns, int outputDepth,
	...
	public interface I4DTensor : IDisposable
	{
		...
		(I4DTensor Result, I4DTensor Indices) MaxPool(int filterWidth, int filterHeight, int xStride,
			int yStride, bool saveIndices);
		...
		/// <param name="yStride">Filter y stride</param>
		/// <returns></returns>
		I4DTensor ReverseMaxPool(I4DTensor indices, int outputRows, int outputColumns, int filterWidth,
			int filterHeight, int xStride, int yStride);
		...
		/// <param name="yStride">Filter y stride</param>
		/// <returns></returns>
		I4DTensor ReverseIm2Col(IMatrix filter, int outputRows, int outputColumns, int outputDepth,
			int filterWidth, int filterHeight, int xStride, int yStride);
