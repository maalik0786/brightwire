...
namespace BrightWire
{
	public static partial class ExtensionMethods
	{
		...
		/// <returns></returns>
		public static IVector CreateVector(this ILinearAlgebraProvider lap, int length,
			float value = 0f)
		{
		...
		public static IMatrix
			CreateZeroMatrix(this ILinearAlgebraProvider lap, int rows, int columns) =>
			lap.CreateMatrix(rows, columns, true);
		...
		/// <returns></returns>
		public static IMatrix CreateMatrixFromRows(this ILinearAlgebraProvider lap,
			IReadOnlyList<FloatVector> rowList)
		{
		...
		/// <returns></returns>
		public static IMatrix CreateMatrixFromRows(this ILinearAlgebraProvider lap,
			IReadOnlyList<IIndexableVector> rowList)
		{
			int rows = rowList.Count;
		...
		/// <returns></returns>
		public static IMatrix CreateMatrixFromColumns(this ILinearAlgebraProvider lap,
			IReadOnlyList<FloatVector> columnList)
		{
		...
		/// <returns></returns>
		public static IMatrix CreateMatrixFromColumns(this ILinearAlgebraProvider lap,
			IReadOnlyList<IIndexableVector> columnList)
		{
			int columns = columnList.Count;
		...
		/// <param name="value">Constant value</param>
		/// <returns></returns>
		public static IMatrix CreateMatrix(this ILinearAlgebraProvider lap, int rows, int columns,
			float value)
		{
		...
		/// <returns></returns>
		public static IMatrix CreateDiagonalMatrix(this ILinearAlgebraProvider lap,
		...
		public static I3DTensor Create3DTensor(this ILinearAlgebraProvider lap, FloatMatrix[] matrices)
		{
			...
			ret.Data = new FloatTensor { Matrix = matrices };
			return ret;
		}
