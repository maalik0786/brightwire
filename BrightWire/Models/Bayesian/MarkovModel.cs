...
namespace BrightWire.Models.Bayesian
{
	...
	public class MarkovModelObservation2<T>
	{
		...
		internal MarkovModelObservation2(T item1, T item2,
			List<MarkovModelStateTransition<T>> transition)
		{
			Item1 = item1;
			Item2 = item2;
	...
	public class MarkovModel2<T>
	{
		...
		{
			get { return Observation.ToDictionary(o => o, o => o.Transition); }
		}
	}
	...
	public class MarkovModelObservation3<T>
	{
		...
		internal MarkovModelObservation3(T item1, T item2, T item3,
			List<MarkovModelStateTransition<T>> transition)
		{
			Item1 = item1;
			Item2 = item2;
