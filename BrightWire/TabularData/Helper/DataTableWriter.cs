...
namespace BrightWire.TabularData.Helper
{
	...
	class DataTableWriter : IRowProcessor, IDataTableBuilder
	{
		...
		public DataTable GetDataTable()
		{
			...
			return new DataTable(_stream, _index, RowCount, null);
		}
		...
		public IRow AddRow(IRow row)
		{
			...
			++RowCount;
			if (RowCount % _dataTableBuilder.BlockSize == 0)
				_Write();
			return ret;
		}
		...
		IColumn IDataTableBuilder.AddTensorColumn(int rows, int columns, int depth, string name,
			bool isTarget)
		{
