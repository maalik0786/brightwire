...
namespace BrightWire
{
	...
	public static class BrightWireProvider
	{
		...
		public static IDataTable ParseCSV(this StreamReader streamReader, char delimeter = ',',
			bool? hasHeader = null, Stream output = null)
		{
		...
		/// <param name="output">A stream to write the data table to (for file based processing) - null for in memory processing</param>
		/// <returns></returns>
		public static IDataTable ParseCSV(this string csv, char delimeter = ',', bool? hasHeader = null,
			Stream output = null)
		{
		...
		/// <param name="output">A stream to write the data table to (for file based processing) - null for in memory processing</param>
		/// <returns></returns>
		public static IDataTable ParseCSVToText(this StreamReader streamReader, char delimeter = ',',
			bool? hasHeader = null, Stream output = null)
		{
		...
		/// <param name="output">A stream to write the data table to (for file based processing) - null for in memory processing</param>
		/// <returns></returns>
		public static IDataTable ParseCSVToText(this string csv, char delimeter = ',',
			bool? hasHeader = null, Stream output = null)
		{
			if (!string.IsNullOrWhiteSpace(csv))
			{
		...
		/// Creates a data table builder to programatically create data tables
		/// </summary>
		public static IDataTableBuilder CreateDataTableBuilder(IEnumerable<IColumn> columns,
			Stream stream = null, bool validate = true)
		{
		...
		public static IConvertToType CreateTypeConverter<T>(T defaultValue = default)
		{
