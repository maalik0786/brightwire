...
namespace BrightWire
{
	...
	public interface INode : ICanInitialiseNode, IDisposable, ICanSerialise
	{
		...
		Models.ExecutionGraph.Node SerialiseTo(HashSet<INode> existing,
	...
	public interface IBackpropagation : IDisposable
	{
		...
		void Backward(INode fromNode, IGraphData errorSignal, IContext context,
	...
	public interface IGraphEngine
	{
		...
		/// <returns></returns>
		ExecutionResult ExecuteSequential(int sequenceIndex, float[] input,
