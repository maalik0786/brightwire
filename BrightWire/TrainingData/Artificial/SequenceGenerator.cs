	...
	public class SequenceGenerator
	{
		...
		static SequenceGenerator()
		{
			_dictionary = Enumerable.Range(0, 26 * 2).
				Select(i => (i < 26) ? (char)('A' + i) : (char)('a' + i - 26)).ToArray();
			_charTable = _dictionary.Select((ch, i) => (ch, i)).ToDictionary(d => d.Item1, d => d.Item2);
		}
		...
		public SequenceGenerator(int dictionarySize, int minSize, int maxSize, bool noRepeat = true,
